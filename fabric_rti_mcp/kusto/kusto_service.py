...
# _QUERY_EXECUTOR = KustoQueryExecutor()
...
# ) -> List[Dict[str, Any]]:
#     """Legacy function that delegates to KustoQueryExecutor for backward compatibility."""
#     return _QUERY_EXECUTOR.execute(query, cluster_uri, readonly_override, database)
...
#         description="Retrieves a list of all Kusto services known to the MCP."
# )
